...
urlpatterns = [
    ...
    path('programs/enter-coaching', views.enter_coaching, name='enter-coaching'),
    path('programs/science-and-art', views.science_and_art, name='science-and-art'),
    path('programs/team-coaching', views.team_coaching, name='team-coaching'),
    path('programs/upraclencheskiy', views.upraclencheskiy, name='upraclencheskiy'),
