...
DATABASES = {
    'default': {
        ...
        'NAME': 'u1165721_perm_bd_exist',
        'USER': 'u1165721_perm_bd',
        'PASSWORD': 'D6t7N7r4',
        'HOST': 'localhost',
    }
}
...
PAGES = [
     ...
     ('/coaching', 'О коучинге'),
     ('/programs', 'Программы'),
     ('/programs/enter-coaching', 'ВВЕДЕНИЕ В КОУЧИНГ'),
    ('/programs/science-and-art', 'НАУКА И ИСКУССТВО КОУЧИНГА'),
    ('/programs/team-coaching', 'Командный коучинг'),
    ('/programs/upraclencheskiy', 'Управленческий коучинг'),
     ('/timetable', 'Распиание'),
